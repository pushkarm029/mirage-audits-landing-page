...
export default function Contact() {
  ...
  return (
    <section className="relative py-16 sm:py-20 bg-black" id="contact" style={{backgroundImage: 'url(/images/backgrounds/noise-bg.webp)', backgroundSize: 'cover', backgroundRepeat: 'repeat'}}>
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base text-white/70 max-w-2xl mx-auto">
            Ship with confidence. Get expert audit coverage before launch. Contact us to discuss your project's security needs.
          </p>
        </div>
