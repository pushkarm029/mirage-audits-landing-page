    ...
    <footer className="relative bg-black text-white" role="contentinfo" style={{backgroundImage: 'url(/noise-bg.png)', backgroundSize: 'cover', backgroundRepeat: 'repeat'}}>
      ...
      <div className="relative">
        ...
        <div className="lg:max-w-[1440px] lg:mx-auto px-3 lg:px-16">
          <div className="bg-white/10 rounded-lg p-4 lg:p-8 mb-4">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
              ...
              <div className="flex flex-wrap gap-4 md:gap-6 lg:gap-8">
                <a href="https://github.com/MirageAudits#contacts-and-profiles" target="_blank" rel="noopener noreferrer" onClick={() => handleNavClick('Portfolio')} className="font-inter text-white/70 hover:text-white transition ease-in-out text-xs md:text-sm leading-5 md:leading-6 uppercase font-light tracking-[0.7px]">
                  Portfolio
                </a>
              ...
              <div className="relative">
                <a 
                  ...
                  className="inline-flex items-center gap-2 font-bold uppercase tracking-wider text-xs md:text-sm px-3 md:px-4 h-8 md:h-10 bg-blue-600 text-white border border-blue-600 hover:bg-blue-700 hover:border-blue-700 rounded-full transition-colors duration-200"
                >
                  Book An Audit
                  <svg 
                    className="w-4 h-4" 
        ...
        {/* Copyright Section */}
        <div className="lg:max-w-[1440px] lg:mx-auto px-3 lg:px-16">
          <div className="text-left pb-3 md:pb-4 text-white/50 text-xs md:text-sm">
