            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-6 lg:space-y-0">
              ...
              <div className="relative">
                ...
                <a href="https://t.me/mirageaudits" target="_blank" rel="noopener noreferrer" onClick={handleCTAClick}>
                  <div className="relative rounded-full bg-white/10 text-white/70 text-sm shadow-lg flex justify-center px-4 py-2 border-2 border-blue-500/60">
                    <p className="font-inter text-opacity-50 cursor-pointer text-white/70 transition ease-in-out hover:text-white uppercase font-light tracking-[0.7px] text-sm">
                      Book An Audit
                    </p>
                  </div>
                </a>
