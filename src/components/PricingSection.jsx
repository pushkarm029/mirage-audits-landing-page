  ...
  return (
    <section id="pricing" className="relative bg-black text-white py-20">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        {/* Main Pricing Card */}
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 backdrop-blur-lg p-8 rounded-xl border border-green-400/30 mb-8">
          <div className="text-center">
            <div className="text-4xl md:text-5xl font-bold text-green-300 mb-2 font-space-grotesk">
              $1K/week
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          <div className="bg-red-500/10 backdrop-blur-lg p-6 rounded-xl border border-red-500/30">
            <h3 className="font-space-grotesk text-lg font-semibold text-red-200 mb-3">
              Traditional Audits
            </h3>
          ...
          <div className="bg-green-500/10 backdrop-blur-lg p-6 rounded-xl border border-green-500/30">
            <h3 className="font-space-grotesk text-lg font-semibold text-green-200 mb-3">
              Mirage Audits
            </h3>
            <ul className="font-inter text-sm text-white/70 space-y-2">
