...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-black text-white" role="contentinfo" style={{backgroundImage: 'url(/images/backgrounds/noise-bg.webp)', backgroundSize: 'cover', backgroundRepeat: 'repeat'}}>
